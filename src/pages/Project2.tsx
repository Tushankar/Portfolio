...
export default function Project2() {
  return (
    <div className="relative w-full min-h-screen bg-[#f3f3f3] overflow-hidden font-barlow text-[#222]">
      {/* Back to Dashboard */}
      <Link to="/#dashboard" className="fixed top-24 left-6 z-50 bg-black/10 hover:bg-black/20 backdrop-blur-md border border-black/10 text-black px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all">
        ← Dashboard
      </Link>
