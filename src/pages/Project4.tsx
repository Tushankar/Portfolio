...
export default function Project4() {
  return (
    <div className="relative h-screen w-full bg-[#21346e] flex flex-col items-start px-6 md:px-12 lg:px-24 py-6 md:py-8 overflow-hidden font-rubik text-white z-0">
      {/* Back to Dashboard */}
      <Link to="/#dashboard" className="fixed top-24 right-6 z-50 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all">
        ← Dashboard
      </Link>
